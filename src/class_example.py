...
class DataProcessor:
    ...
    def add_fullname_to_users(self) -> list:
        ...
        """
        data_set = self._load_json(self.users_json_path)
        return [
    ...
    def associate_users_with_companies(self) -> list:
        ...
        """
        user_data_set = self._load_json(self.users_json_path)
        company_data_set = self._load_json(self.company_json_path)
